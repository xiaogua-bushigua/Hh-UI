...
const code = `<hh-button type="primary" @click="handleChangeHeight">自适应尺寸</hh-button>
<hh-button type="primary" @click="handleChangeChart">更改options</hh-button>
<hh-echarts :height="height" :width="width" :option="option"></hh-echarts>`
  ...
  <div class="echartsPage">
    ...
    <div class="echarts">
      ...
      <div>
        ...
        <hh-button type="primary" @click="handleChangeSize">自适应尺寸</hh-button>
        <hh-button type="primary" @click="handleChangeChart">更改options</hh-button>
        <hh-echarts :height="height" :width="width" :option="option"></hh-echarts>
      </div>
    </div>
